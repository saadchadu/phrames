      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-primary">My Campaigns</h1>
            ...
            <div className="flex space-x-3">
              ...
              <Link
                href="/create"
                className="bg-secondary hover:bg-secondary/90 text-primary px-6 py-3 rounded-lg font-semibold flex items-center space-x-2 transition-colors"
              >
          ...
          {campaigns.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Link
                href="/create"
                className="bg-secondary hover:bg-secondary/90 text-primary px-6 py-3 rounded-lg font-semibold inline-flex items-center space-x-2 transition-colors"
              >
                <PlusIcon className="h-5 w-5" />
