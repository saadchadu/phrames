            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="flex flex-col gap-4 sm:gap-6">
                ...
                <div className="flex flex-col gap-2 w-full">
                  ...
                  <input
                    ...
                    required
                    className={`w-full px-4 py-3 sm:py-3.5 border rounded-xl text-base text-primary placeholder:text-[#00240066] focus:outline-none focus:ring-2 transition-all bg-white ${slugError
              ...
              <div className="flex flex-col gap-2 w-full">
                ...
                <p className="text-primary/60 text-xs leading-relaxed">
                  PNG format with transparency required • Supported aspect ratios: 1:1 (1080×1080px), 4:5 (1080×1350px), 3:4 (1080×1440px), 9:16 (1080×1920px) • Maximum file size: 10MB
                </p>
                {aspectRatio && frameDimensions && (
                  <div className="mt-2 inline-flex items-center gap-2 px-3 py-1.5 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <span className="text-green-700 text-sm font-medium">
                      {frameDimensions.width} × {frameDimensions.height}px · {aspectRatio}
                    </span>
                  </div>
                )}
              </div>
